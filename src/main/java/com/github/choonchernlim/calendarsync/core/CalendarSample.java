package com.github.choonchernlim.calendarsync.core;
...
public class CalendarSample {
     ...
     */
    private static Credential authorize(String clientSecretJsonFilePath) throws Exception {
        // load client secrets
    ...
    public static void main(String[] args) {
        final String clientSecretJsonFilePath = args[0];
        ...
        try {
            ...
            // authorization
            Credential credential = authorize(clientSecretJsonFilePath);
